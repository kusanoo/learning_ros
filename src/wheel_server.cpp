...
#include "learning_ros/Wheel.h"  // 自動的に作られる                                         
...
public:
  ...
  bool wheelService(learning_ros::Wheel::Request  &req,
                    learning_ros::Wheel::Response &res);
  void loop(); // ループ関数                                                               
...
// サーバーのコールバック関数                                                              
bool Server::wheelService(learning_ros::Wheel::Request  &req,
                          learning_ros::Wheel::Response &res)
{
